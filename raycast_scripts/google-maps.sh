...
if [ "$1" = "" ]; then
	open -a "Brave browser" "https://www.google.com/maps"
elif [ "$2" = "" ]; then
	open -a "Brave browser" "https://www.google.com/maps/search/$first_argument"
else
	open -a "Brave browser" "https://www.google.com/maps/dir/$first_argument/$second_argument"
fi